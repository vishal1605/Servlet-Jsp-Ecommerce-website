...
<div class="shipping-page">
     ...
     <span style="font-size:25px;">Total amounts :<b><%=totalValue %></b></span>
  ...
  <div class="form-group">
    ...
    <input type="hidden" class="form-control" value="<%=u.getAddress() %>" id="inputAddress" name="address" required>
    <p><b><%=u.getAddress() %></b></p>
  </div>
  <div class="form-row">
    <div class="form-group col-md-4">
      <label for="inputCity">City</label>
      <input type="hidden" class="form-control" value="<%=u.getCity() %>" id="inputCity" name="city" required>
      <p><b><%=u.getCity() %></b></p>
    </div>
    <div class="form-group col-md-4">
      <label for="inputState">State</label>
      <input type="hidden" class="form-control" value="<%=u.getState() %>" id="inputAddress" placeholder="" name="state" required>
      <p><b><%=u.getState() %></b></p>
    </div>
  </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-4">
      ...
      <input type="hidden" class="form-control" value="<%=u.getContact() %>" id="inputAddress" placeholder="" name="contact" required>
      <p><b><%=u.getContact() %></b></p>
    </div>
    <div class="form-group col-md-4">
      <label for="inputZip">Zip code</label>
      <input type="hidden" class="form-control" value="<%=u.getPincode() %>" id="inputZip" name="zip" required>
      <p><b><%=u.getPincode() %></b></p>
    </div>
  </div>
  
  <button type="submit" class="btn btn-primary">Proceed to Checkout</button>
  <button type="button" class="btn btn-primary"><a href="Shipping.jsp" style="text-decoration:none; color:white">Update Address</a></button>
</form>
