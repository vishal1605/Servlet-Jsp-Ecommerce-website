                ...
                %>
                        ...
                        <table class="table table-borderless mt-3 text-center">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td>UserName</td>
                                <td><input type="text" class="form-control" value="<%=a.getUserName() %>" name="edit-name" required></td>
                              </tr>

                              <tr>
                                <td>Email</td>
                                <td><input type="email" class="form-control" value="<%=a.getEmail() %>" name="edit-email" required></td>
                              </tr>
                          ...
                          <button type="button" class="btn btn-primary"><a href="AdminDashboard.jsp" style="text-decoration: none; color: white;">Cancel</a></button>
                          </div>
                          </form>
